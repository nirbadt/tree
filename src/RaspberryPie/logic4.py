...
pygame.mixer.music.load(MP3_PATH + "match1.wav")
...
def in_standby(state, message):
    if message == MSG_TOUCH:
        ...
        pygame.mixer.music.load(MP3_PATH + "my_sound16.wav")
        pygame.mixer.music.play()
    elif message == MSG_GOT_INVITED:
        to_state(state, ST_BEEN_INVITED, LED_BEEN_INVITED)
        pygame.mixer.music.load(MP3_PATH + "other_sound16.wav")
        pygame.mixer.music.play()
...
def in_charging(state, message):
    if message == MSG_RELEASE:
        ...
        pygame.mixer.music.load(MP3_PATH + "both_sound16.wav")
        pygame.mixer.music.play()
...
while True:
    ...
    if touched:
        ...
        if last_touched == True:
            ...
            pygame.mixer.music.stop()
            pygame.mixer.music.load(MP3_PATH + "my_sound16_reversed2.wav")
            pygame.mixer.music.play()
